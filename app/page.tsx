...
{canViewAdminTools && (
  <div className="mb-6 rounded-2xl border border-purple-200 bg-purple-50 p-4">
    ...
    <div className={canViewBorrowerPortal ? "mb-6 rounded-2xl bg-slate-50 p-5" : "hidden"}>
...
<div className="mt-4 flex gap-3">
  ...
  >
    Cancel
             ...
             <div className={!currentUserEmail || previewRole === "Borrower" ? "hidden" : "grid gap-4 md:grid-cols-3"}>
                <div className="rounded-2xl bg-slate-50 p-5">
